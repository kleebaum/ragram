...
#' 
#' Plots the disparity map of two SAR records. 
...
#' data(kili)
#' 
#' plotDisparityMap(kili[[1]], kili[[2]])
#' plot(disparityMap(kili[[1]], kili[[2]]))
#' 
#' plotDisparityMap(kili)
setGeneric('plotDisparityMap', function(object, slave, z='thetaIn',
                                        ...
                                        ...) {
    standardGeneric('plotDisparityMap')
})

#' @export
setMethod('plotDisparityMap', 'SAR',
          function(object, slave=NULL, ...) {
              plotAnglesDif(object, slave, ...)
          }
)

#' @name plotDisparityMap
#' @rdname plotDisparityMap
#' @export
setMethod('plotDisparityMap', c('SAR', 'SAR'),
...
#' @rdname plotDisparityMap
#' @export
setMethod('plotDisparityMap', 'SARSet',
          function(object, slave=NULL, ...) {
              plotAnglesDif(master, slave,
                            z, xlab, ylab,
                            breaks, col.regions, 
