...
#' 
#' @param x Object of the \code{\link{SAR-class}} or a subclass (e.g. \code{\link{Sentinel-class}} or \code{\link{TSX-class}}).
#' @param CRSobj Object of class \code{\link[sp]{CRS-class}}, or of class character in which case it is converted to \code{\link[sp]{CRS-class}}.
