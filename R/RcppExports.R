...
getStandardDeviationCpp <- function(img, u, v, n) {
    .Call('_ragram_getStandardDeviation', PACKAGE = 'ragram', img, u, v, n)
}
...
getAverageCpp <- function(img, u, v, n) {
    .Call('_ragram_getAverage', PACKAGE = 'ragram', img, u, v, n)
}

getAvgAndSDCpp <- function(img, u, v, n) {
    .Call('_ragram_getAvgAndSD', PACKAGE = 'ragram', img, u, v, n)
}
...
znccCpp <- function(master, slave, u1, v1, u2, v2, n) {
    .Call('_ragram_zncc', PACKAGE = 'ragram', master, slave, u1, v1, u2, v2, n)
}

znccMatrixCpp <- function(master, slave, index, u, v, n, searchAreaShift) {
    .Call('_ragram_znccMatrix', PACKAGE = 'ragram', master, slave, index, u, v, n, searchAreaShift)
}

disparityMapCpp <- function(master, slave, index, n, uStart, uEnd, vStart, vEnd, searchAreaShift) {
    .Call('_ragram_disparityMap', PACKAGE = 'ragram', master, slave, index, n, uStart, uEnd, vStart, vEnd, searchAreaShift)
}

znccMultipliedCpp <- function(master, slave, u1, v1, u2, v2, n) {
    .Call('_ragram_znccMultiplied', PACKAGE = 'ragram', master, slave, u1, v1, u2, v2, n)
}

znccMultipliedMatrixCpp <- function(master, slave, index, u, v, n, searchAreaShift) {
    .Call('_ragram_znccMultipliedMatrix', PACKAGE = 'ragram', master, slave, index, u, v, n, searchAreaShift)
}
